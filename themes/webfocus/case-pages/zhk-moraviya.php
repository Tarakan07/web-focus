...
<main class="casewf casewf_24">
    ...
    <div class="container">
      <div class="case-info-wrapper">
        ...
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case24_7.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case24_3.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>Для каждой страницы на сайте написаны уникальные тексты, соответствующие всем параметрам SEO, они хорошо продвигают сайт в поисковых системах.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case24_4.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112 casewf_bottom0">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case24_5.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case24_6.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std section-std-bottom-0 casewf_top112">
    <div class="container custom-style__padding-bottom-50">
      ...
      <p class='section-p ms-740'>Сайт привлекает внимание множества пользователей, а качественный дизайн вызывает доверие. Таким образом, у компании «Центр регистрации бизнеса» сильно увеличилось количество клиентов, готовых заказать услугу. </p>
      <div class="casewf_link">
        <a href="#">Перейти на сайт</a>
      </div>
