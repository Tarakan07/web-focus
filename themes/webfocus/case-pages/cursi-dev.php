<?php
/*
Template Name: Курсы разработки
...
<main class="casewf casewf_38">
    <!-- <div class="background-page-37"> -->
        ...
        <div class="case_wf_hero_container case_wf_hero_inner">
          ...
          ?>
            ...
            <!-- <div class="baner-image">
                <img src="<?php //the_field("dopolnitelnye_izobrazheniya_dlya_yaziksita"); ?>" alt="#">
            </div> -->
        </div>
    </section>
    <section class="section-std case_wf_task casewf_top112 casewf_bottom0">
        <div class="container white-color">
            <div class="case-info-wrapper">
                ...
                <div>
                    <img src="https://webfocus.by/wp-content/uploads/2023/09/group-1321314022.png" alt="#">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-std section-wf-std grey-background casewf_top112">
            <div class="container black-color">
            <h2 class="section-title">Стилизация элементов</h2>
  ...
  <section class="section-std section-wf-std casewf_top112 ">
        <div>
            <div class="container">
            <h2 class="section-title">Иллюстрации</h2>
            <p class='section-p ms-740'><?php the_field("illyustraczii_podzagolovok"); ?></p>
            </div>
            <div class='case-main-screen__img'>
                <?php 
    ...
    <div class="container">
      <h2 class="section-title">Дизайн главной страницы</h2>
  ...
  <section class="section-std section-wf-std casewf_top112 casewf_bottom0 blue-background">
    <div class="container white-color">
      <h2 class="section-title">Дизайн второстепенных страницы сайта</h2>
      <p class='section-p ms-740'><?php the_field("vtorostepennye_straniczy"); ?></p>
      <div class='case-main-screen__img height-690'>
        <?php 
  ...
  <section class="section-std section-wf-std casewf_bottom0 degin-background-image" style=" background-image: url(<?php $image = get_field('adaptivnyj_dizajn_ilust'); if( !empty($image) ): ?> <?php echo $image['url']; ?><?php endif; ?>);">
    <div class="container">
        <h2 class="section-title">Адаптивный дизайн</h2>
        <p class='section-p ms-740'><?php the_field("adaptivnyj_dizajnpodzagolovok"); ?></p>
        </div>
  </section> 
  <section class="section-std section-wf-std casewf_top0 smm-background-image" style=" background-image: url(<?php $image = get_field('lenta-instagram-pc'); if( !empty($image) ): ?> <?php echo $image['url']; ?><?php endif; ?>);">
    <div class="container">
  ...
  <section class="section-std section-wf-std casewf_top112 casewf_bottom0 blue-background">
    ...
    <section class="section-std section-wf-std casewf_top112 casewf_bottom0">
        <div class="container">
        <h2 class="section-title">Стилистика баннеров</h2>
