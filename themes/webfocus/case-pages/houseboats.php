...
<main class="casewf casewf_28">
  <section class="section-std case_wf_hero sub-hero case_wf_color2 case_wf_color">
      ...
      <div class="case_wf_hero_wrapper">
        <div class="sub-hero-wrapper case">
          ...
          <div class="sub-hero__info-wrapper case-page__subtitle">
            Дизайн презентации компании по производству хаусботстов
          </div>
        </div>
        ...
        <div class="casewf_link">
          <a href="<?php echo get_template_directory_uri(); ?>/assets/img/case/Houseboats.pdf" download>Скачать pdf-файл</a>
        </div>
      </div>
    </div>
  </section>

  <section class="section-std case_wf_task casewf_top112 casewf_bottom0 casewf28_mw1">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Перед нами стояла задача создать презентацию для компании Houseboats. В пожеланиях клиента были приятный и стильный дизайн</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы выполнили дизайн презентации в минималистичном стиле в сочетании с фотографиями продукции, при этом не отвлекая от главной информации.</p>
          </div>
        </div>
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/case/case28_2.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 ">
    <div class="container">
      <h2 class="section-title">Страницы презентации</h2>
      <p class='section-p ms-740'>МЫ использовали разного типа слайды, чтобы при просмотре презентации, информация запоминалась.</p>

      <div class='case-main-screen__img'>
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/case/case28_3.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 ">
    <div class="container">
      <div class="title-wrp">
        <h2 class="section-title">Вся презентация</h2>
        <a class="title-link" href="<?php echo get_template_directory_uri(); ?>/assets/img/case/Houseboats.pdf" download>Скачать pdf-файл</a>
      </div>
      <p class='section-p ms-740'>Ниже представлена презентация в полнм объеме, также Вы можете ее сохранить в формате pdf.</p>
      ...
      <div class="case-slider ">
        <?php for ($i = 1; $i < 13; $i++) { ?>
          <div class="case-slider-card">
            <div class='case-main-screen__img'>
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/cases/houseboats/Houseboats_slide_<?php echo $i; ?>.jpg" alt="" class=''>
            </div>
          </div>
        <?php } ?>

      </div>
      <div class="case-slider-pagin">
        <div class="reviews-slider-nav">
          <div class="reviews-slider-prev-btn">
          ...
          <div class="reviews-slider-next-btn">
            <svg width="81" height="8" viewBox="0 0 81 8" xmlns="http://www.w3.org/2000/svg">
  ...
  <section class="section-std section-std-slider section-wf-std section-std-bottom-0 casewf_top112">
    <div class="container custom-style__padding-bottom-50">
      <h2 class="section-title">Результат</h2>
      <p class='section-p ms-740'>В результате мы создали презентацию, учитывая пожелания заказчика, в лаконичном стиле без лишних деталей. В цветовой палитре мы использовали приятные и приглушенные цвета.</p>
