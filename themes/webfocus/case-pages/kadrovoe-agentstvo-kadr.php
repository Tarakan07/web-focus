...
/*
Template Name: Кадровое агентство KADR
...
<main class="casewf casewf_1">
  <section class="section-std case_wf_hero sub-hero">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_1.png" alt="" class=''>
    </div>
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_2.png" alt="" class=''>
        </div>
  ...
  <section class="section-std section-wf-std">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_3.gif" alt="" class=''>
      </div>
    </div>
  </section>
  <section class="section-std section-wf-std">
    <div class="container">
      ...
      <p class='section-p ms-740'>Агентство занимается подбором персонала. Они заказали у нас нейминг и разработку логотипа. Получилось стильное и понятное решение, близкое аудитории разных возрастов. </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_4.png" alt="" class=''>
      </div>
    </div>
  </section>
  <section class="section-std section-wf-std">
    <div class="container">
      ...
      <p class='section-p ms-740'>На сайте всего три цвета, но он смотрится очень ярким и приветливым. Шрифт “Montserrat” отражает стильность и современность сайта. </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_5.png" alt="" class=''>
      </div>
    </div>
  </section>
  <section class="section-std section-wf-std section-wf-width">
    <div class="container">
      <h2 class="section-title">Карусели постов</h2>
      <p class='section-p ms-740'>В каруселях постов мы рассказали интересную информацию о питомцах, продукции магазин.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_6.png" alt="" class=''>
    </div>
  </section>
  <section class="section-std section-wf-std">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case1_7.png" alt="" class=''>
      </div>
    </div>
  </section>
