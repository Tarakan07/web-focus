...
<main class="casewf casewf_27">
  <section class="section-std case_wf_hero sub-hero case_wf_color2 case_wf_color casewf_grad">
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Задачей стояло разработать стиль инстаграма салона красоты который бы отражал атмосферу в нем. Создали мы ее с помощью фотографий, уникальных форм и акцидентного шрифта.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы разработали удобный сайт-портал, на котором пользователь может найти множество предложений по аренде и покупке недвижимости. На главном экране присутствует фильтр, позволяющий подобрать именно то, что необходимо клиенту. Сайт лаконичен, минималистичен и выполнен в спокойных цветах.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      <h2 class="section-title">Типографика и цветовая палитра</h2>
      <p class='section-p ms-740'>В цветовой палитре мы подобрали минималистичную палитру с дополнительным цветом. Акцентным шрифтом проекта был выбран «New-YorkerC».</p>

      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_2.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_2_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 section-wf-width">
    <div class="container">
      <h2 class="section-title">Истории Instagram</h2>
      <p class='section-p ms-740'>В дизайне историй мы использовали фотографии, отражающие атмосферу в салоне.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_3.png" alt="" class='hide_image_930'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_3_930.png" alt="" class='show_image_930 hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_3_650.png" alt="" class='show_image_650'>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      <h2 class="section-title">Обложки для хайлайтс</h2>
      <p class='section-p ms-740'>В обложках для хайлайтс мы использовали иллюстрации, выполненные одной линией.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_4.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_4_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      <h2 class="section-title">Лента Инстаграма</h2>
      <p class='section-p ms-740'>В ленте инстаграма мы сочетали информационные посты с фотографиями.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_5.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 casewf27_mw1 case_wf_color">
    <div class="container">
      <h2 class="section-title">Карусели постов</h2>
      <p class='section-p ms-740'>В каруселях постов мы разместили полезную информацию для клиентов об услугах, которые реализуются в салоне.</p>
    </div>
    <div class="container">
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_8.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_8_930.png" alt="" class='show_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case27_8_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std section-std-bottom-0 casewf_top112">
    <div class="container custom-style__padding-bottom-50">
      ...
      <p class='section-p ms-740'>В результате был создан инстаграм с постами, отражающими атмосферу в салоне , которые не только полезные, но и привлекают новых клиентов.</p>
