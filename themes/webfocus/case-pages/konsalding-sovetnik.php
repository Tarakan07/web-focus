...
<section class="section-std case_wf_hero sub-hero case_wf_color">
    <div class="case_wf_hero_container case_wf_hero_inner">
      <div class="case_wf_hero_wrapper">
        ...
        <div class="casewf_link">
          <a href="https://sovetnik.by/">Перейти на сайт</a>
        </div>
      </div>
    </div>
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case31_1.png" alt="" class=''>
    </div>
  </section>
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Компания “Советник” занимается консалтингом в сфере бизнеса. Перед нами стояла задача разработать удобный сайт для продажи консалтинговых услуг.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы разработали минималистичный дизайн для компании “Советник”. На сайте есть список предлагаемых компанией услуг и вся необходимая информация о компании, Сайт выполнен с использованием корпоративного цвета. Он прост и удобен в использовании.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-std section-wf-std casewf_top112 ">
    <div class="container">
      ...
      <p class='section-p ms-740'>Логотип выполнен в фирменном цвете. Аккуратный шрифт с засечками говорит о серьезности компании, а зеленый корпоративный цвет приветлив для клиента.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case31_2.png" alt="" class=''>
      </div>
    </div>
  </section>
  <section class="section-std case_wf_task case_wf_color display-none">
    <div class="container">
      <h2 class="section-title">Главная страница</h2>
      <p class='section-p ms-740'>
      На главной странице есть вся необходимая информация: описание услуг, отзывы, чтобы убедить клиента в компетентности компании, расценки и возможность связаться с менеджером, чтобы оформить консультацию.
      </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_4.png" alt="" class=''>
      </div>
    </div>
  </section>
  <section class="section-std case_wf_task display-none">
    <div class="container">
      <h2 class="section-title">Адаптивный дизайн</h2>
      <p class='section-p ms-740'>
      Наши разработчики всегда очень ответственно подходят к реализации адаптивов. Сайт хорошо выглядит на устройствах различных разрешений.
      </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_4.png" alt="" class=''>
      </div>
  ...
  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112 case_wf_color_c31">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      <h2 class="section-title">SEO-продвижение
      </h2>
      <h4 class='section-p'>Сфера – консалтинг</h4>
      <h4 class='section-p'>Возраст – 2 года 1 мес</h4>
      <h4 class='section-p'>Трафик на старте – 0 посетителей в неделю</h4>
      <h4 class='section-p'>Цели:</h4>
      
      <div class='custom-style__seo-text'>
        <p>Сайт с возрастом и небольшим ссылочным профилем. Перестал расти органический трафик. Необходимо расширить перечень предоставляемых услуг</p>
        <ul>
          <li>Дубли страниц;</li>
          <li>Мета-теги не оптимизированы;</li>
          <li>Присутствовали потерянные страницы;</li>
          <li>Страницы с отсутствующим H1</li>
          <li>Страницы с дублирующими title и H1;</li>
        </ul>
      </div>
      <h4 class='section-p'>Выполненные работы:</h4>
      <div class='custom-style__seo-text'>
        <ul>
          <li>Расширение структуры сайта и семантического ядра;</li>
          <li>Удаление битых ссылок;</li>
          <li>Составление контент-плана</li>
          <li>Оптимизация страниц пагинации;</li>
          <li>Исправлены технические ошибки;</li>
          <li>Анализ ссылочного профиля;</li>
          <li>Увеличение ссылочного профиля сайта;</li>
      ...
      <div class="custom-style__seo-text">
      В начале работ трафик составлял 200 посетителей в неделю, а за 10 месяцев работы вырос до 500 визитов в неделю. 
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case31_3.svg" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Прогноз трафика вырос:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case31_4.svg" alt="" class=''>
      </div>
    </div>
  </section>
