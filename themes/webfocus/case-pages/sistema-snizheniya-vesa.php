<?php
/*
Template Name: Система снижения веса
...
<section class="section-std case_wf_hero sub-hero case_wf_color2">
  ...
  <section class="section-std case_wf_task casewf_top112 casewf_bottom0 color-aquo">
    <div class="container white-color">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper ">
          <div>
            <h3>Задача:</h3>
            <p>Когда Наталья обратилась к нам, сразу сообщила, что в корне не устраивает дизайн старого сайта, и его необходимо изменить. Перед нашим специалистом стояла серьезная задача – отразить концепцию заказчика в красках и оттенках. </p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Ненавязчивая палитра нового дизайна буквально сразу погружает в тему. Тщательно проработана человекоориентированность указанного ресурса. Человек – часть Природы. Такой мотив прослеживается в этом проекте. Создается ощущение гармонии, человек словно настраивается на то, что в корне изменит собственный образ жизни, но естественным путем, а не через насилие над самим собой.</p>
          </div>
        </div>
      </div>
    </div>
  </section>
  <section class="section-std section-wf-std casewf_top112 color-aquo">
    <div class="container white-color">
      ...
      <div class='case-main-screen__img'>
        <img src="https://webfocus.by/wp-content/uploads/2021/04/7a50c9dcfe642dbed2edae819878104c.gif"   alt="" class=''>
      </div>
    </div>
  </section>
  <section class="section-std section-wf-std casewf_top112 color-aquo">
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container black-color">
      ...
      <p class='section-p ms-740'><?php the_field("vizualnyj_yazyk_sajta"); ?></p>
      <div class='case-main-screen__img'>
      <div class="desktop-image-block">
        <?php 
  ...
  <section class="section-std section-wf-std">
    <div class="container black-color">
      ...
      <div class='case-main-screen__img'>
        <div class="desktop-image-block width-80">
        <?php 
  ...
  <div class="container white-color">
      ...
      <p class='section-p ms-740'><?php the_field("adaptivnyj_dizajnpodzagolovok"); ?></p>
      <div class='case-main-screen__img'>
        <div class="adaptiv-image">
        <?php 
  ...
  <section class="section-std section-wf-std color-aquo">
    <div class="container white-color">
      <h2 class="section-title">Корзина и личный кабинет</h2>
      <p class='section-p ms-740'><?php the_field("korzina_i_lichnyj_kabinet_podzagolovok"); ?></p>
      <div class='case-main-screen__img'>
        <?php 
