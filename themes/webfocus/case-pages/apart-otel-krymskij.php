...
/*
Template Name: Апарт-отель Крымский
...
<main class="casewf casewf_23">
  <section class="section-std case_wf_hero sub-hero case_wf_color2 case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case23_1.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std case_wf_task casewf_top112 casewf_bottom0 case_wf_color">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Создать сайт-портал для компании Grand Realt с каталогом предложений.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
  ...
  case_wf_color">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case23_2.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case23_2_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112 case_wf_color casewf_bottom0">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case23_3.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case23_4.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std section-std-bottom-0 casewf_top112 case_wf_color">
