...
section-wf-width">
    <div class="container">
      ...
      <p class='section-p ms-740'>Было создано 6 пакетов баннеров, каждый из них обладает уникальным дизайном и отвечает наиболее популярным запросам клиента по выбору услуг.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case22_2.png" alt="" class='hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case22_2_650.png" alt="" class='show_image_650'>
    </div>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case22_3.png" alt="" class='hide_image_930'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case22_3_930.png" alt="" class='show_image_930 hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case22_3_650.png" alt="" class='show_image_650'>
    </div>
  </section>
