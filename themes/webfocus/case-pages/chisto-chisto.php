...
<main class="casewf casewf_34">
  <section class="section-std case_wf_hero sub-hero casewf_bottom0 case_wf_color2 case_wf_color color-gradient-blue">
    <div class="case_wf_hero_container case_wf_hero_inner">
        <img src="/wp-content/uploads/2023/09/ellipse-72.png" class="bubble-image bubble-wrapper-1" alt="#">
        <img src="/wp-content/uploads/2023/09/ellipse-73.png" class="bubble-image bubble-wrapper-2" alt="#">
        <img src="/wp-content/uploads/2023/09/ellipse-74.png" class="bubble-image bubble-wrapper-3" alt="#">
  ...
  <section class="section-std case_wf_task casewf_bottom0 color-gradient-blue">
    <div class="container">
      <div class="case-info-wrapper">
        ...
        <img src="/wp-content/uploads/2023/09/group-8644.png" alt="#" class="botel-image-wrapper">
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 color-gradient-blue">
    <div class="container">
  ...
  <section class="section-std section-wf-std casewf_top112 section-wf-width">
    <div class="container">
    ...
    <?php 
            $image = get_field('kopirajting_ilyustracziya');
                    if( !empty($image) ): ?>
            <img class="pressed-right" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
      <?php endif; ?>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112 color-gradient-blue">
    <div class="container">
      <h2 class="section-title">Сторис для Instagram</h2>
      <p class='section-p ms-740'><?php the_field('stories-instagram')?></p>
      <div class='case-main-screen__img full-width-img'>
      <?php 
            $image = get_field('stories-instagram-image');
                    if( !empty($image) ): ?>
            <img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
      <?php endif; ?>
      </div>
  ...
  <section class="section-std section-wf-std section-std-bottom-0 casewf_top0 color-gradient-blue">
