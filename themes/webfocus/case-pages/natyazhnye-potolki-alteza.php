...
/*
Template Name: Натяжные потолки Alteza
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Перед нами стала задача создать визуальный стиль для инстаграма магазина товаров для домашних животных vvpzoovet.by</p>
          </div>
          <div>
            <h3>Реализация:</h3>
        ...
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_2.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_3.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_4.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color case_wf784">
    <div class="container">
      <h2 class="section-title">Разработка сайта и копирайтинг</h2>
      <p class='section-p ms-740'>Главная страница сайта включает в себя блоки, необходимые для понимания клиентом работы компании и предоставляемых ей услуг. Сайт легкий и минималистичный, в нем очень удобно ориентироваться.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_5.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_5_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color section-wf-width">
    <div class="container">
      <h2 class="section-title">Контекстная реклама</h2>
      <p class='section-p ms-740'>Было создано 6 пакетов баннеров, каждый из них обладает уникальным дизайном и отвечает наиболее популярным запросам клиента по выбору слуг.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_6.png" alt="" class='hide_image_1090'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_6_1090.png" alt="" class='show_image_1090 hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case16_7_650.png" alt="" class='show_image_650'>
    </div>
