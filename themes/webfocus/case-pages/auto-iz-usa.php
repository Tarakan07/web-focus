...
<main class="casewf casewf_30">
  <section class="section-std case_wf_hero sub-hero case_wf_color ">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_1.png" alt="" class=''>
    </div>

  </section>
  <section class="section-std case_wf_task section-std-bottom-0">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_2.png" alt="" class=''>
        </div>
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Наш клиент занимается продажей подержанных автомобилей из США в Беларуси. Нужно было разработать Инстаграм с каталогом автомобилей.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы создали приветливый дизайн ленты Инстаграм. Нужно было использовать максимальное количество фотографий, предоставленных клиентом, для демонстрации товара. Мы оформили их в информативные посты.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-std section-wf-std casewf_top112 ">
    <div class="container">
      ...
      <p class='section-p ms-740'>Для данного проекта мы выбрали шрифт без засечек “Montserrat”. В цветовой палитре использовали приятные и дружелюбные цвета, которы располагают к себе.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_3.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_6.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  <section class="section-std section-wf-std">
    <div class="container">
      ...
      <p class='section-p ms-740'>В ленте инстаграма мы использовали посты разного плана.</p>
      <div class='case-main-screen__img'>
  ...
  <section class="section-std section-wf-std section-wf-width">
    ...
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case30_5.png" alt="" class=''>
    </div>
  </section>
  ...
  <section class="section-std case_wf_task  case_wf_color">
    <div class="container custom-style__padding-bottom-50">
      ...
      <p class='section-p ms-740'><?php the_field('rezultatpodzagolovok'); ?>
      Мы смогли создать удобную ленту для аккаунта в Инстаграм, в которой потенциальный клиент может легко найти все необходимую информацию об интересующем товаре. Аккаунт продвигается в Инстаграм и приносит компании новых клиентов.
    </p>
