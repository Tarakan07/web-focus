...
/*
Template Name: Курсы SMM в Минске
...
<main class="casewf casewf_3">
    ...
    <div class="case_wf_hero_container case_wf_hero_inner">
      <div class="case_wf_hero_wrapper">
        ...
        <div class="casewf_link">
          <a href="https://smm.webfocus.by">Перейти на сайт</a>
        </div>
      </div>
    </div>
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_1.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std case_wf_task">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_icon1.png" alt="" class=''>
            <p>Разработать сайт для представления курсов по SMM-продвижению от компании “Веб Фокус”.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_icon2.png" alt="" class=''>
            <p>Мы разработали очень яркий и привлекающий внимание сайт, который отлично передает дух профессии и привлекает аудиторию, сподвигая ее к покупке товара, предоставляемого компанией.</p>
          </div>
        </div>
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_2.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std">
    <div class="container">
      <h2 class="section-title">Разработка логотипа</h2>
      <p class='section-p ms-740'>В логотипе зашифровано название компании, которая организовывает курсы по SMM - Веб Фокус. А две первые буквы означают тематику курсов.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_3.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std">
    <div class="container">
      <h2 class="section-title">Цветовая палитра и типографика</h2>
      <p class='section-p ms-740'>На сайте всего три цвета, но он смотрится очень ярким и приветливым. Шрифт “Montserrat” отражает стильность и современность сайта. А emoji дополняют картину, делая дизайн молодежным и привлекательным для посетителей.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_4.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_4_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color">
    <div class="container">
      <h2 class="section-title">Разработка и дизайн сайта</h2>
      <p class='section-p ms-740'>На главной странице мы разместили информацию о компании, емко описали предоставляемые услуги и рассказали о возможностях.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_5.gif" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      <h2 class="section-title">UI-kit</h2>
      <p class='section-p ms-740'>Над дизайном этого сайта было очень приятно и весело работать: смелые цветовые решения, стильные конструктивные элементы. А анимации придают сайту жизнь. </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_6.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_6_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std">
    <div class="container">
      <h2 class="section-title">Элементы сайта</h2>
      <p class='section-p ms-740'>Над дизайном этого сайта было очень приятно и весело работать: смелые цветовые решения, стильные конструктивные элементы. А анимации придают сайту жизнь. </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_7.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_7_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color casewf_bottom0 section-wf-width">
    <div class="container">
      <h2 class="section-title">Второстепенные страницы</h2>
      <p class='section-p ms-740'>Создание второстепенных страниц - всегда кропотливый процесс. Сайт “Северный дом” изобилует качественными фотографиями, отражающими суть услуг. Для каталога строительной техники мы подбирали лучшие фотографии с актуальной техникой, которая присутствует в распоряжении строительной компании.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_8.png" alt="" class='hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_8_650.png" alt="" class='show_image_650'>
    </div>

  </section>


  <section class="section-std our-team section-std-bottom-0 case_wf_color">
    <div class="container custom-style__padding-bottom-50">
      <h2 class="section-title">Мобильная версия сайта</h2>
      <p class='section-p ms-740'>Большинство пользователей заходят в интернет с мобильных устройств. Поэтому так важно делать мобильные версии сайтов идеальными внешне и удобно в использовании.</p>
    </div>
  </section>
  <section class="section-std our-team case_wf_color section-wf-width casewf_bottom112">
    <div class='case-slider-wrapper-mask'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_mask.png" alt="alt">
    </div>
  ...
  <script>
    var elem = document.querySelector('.case-slider-wrapper>div');
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      <h2 class="section-title">Лента Instagram</h2>
      <p class='section-p ms-740'>Для компакнии также было создано оформление социальных сетей. На примере ленты Instagram показываем, что получилось. </p>

      <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_99.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      <h2 class="section-title">SEO-продвижение</h2>
      <h4 class='section-p'>Сфера - бизнес-портал</h4>
      <h4 class='section-p'>Возраст сайта - 1 год</h4>
      <h4 class='section-p'>Трафик на старте работ – 0 посетителей в неделю.</h4>
      <h4 class='section-p'>Проблематика:</h4>
      <div class="custom-style__seo-text">
        <p>
          Из-за того, что сайт молодой, возникли трудности в органическом поиске.
          Изначально была небольшая структура сайта и небольшой охват ключевых слов.
        </p>
      </div>
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_10.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_11.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color case_wf_rel casewf_bottom0">
    <div class="container">
      <h2 class="section-title">PPC (контекстная реклама)</h2>
      <p class='section-p ms-740'>Для привлечения внимания к компании “Кадр” мы прибегли к контекстной рекламе. Было создано 10 рекламных креативов, которые рекламировали сайт на разных ресурсах.</p>

      <div class='case-main-screen__img '>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_12.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case3_12_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
