<?php
/*
Template Name: Бухгалтерские технологии
...
<main class="casewf casewf_37">
    ...
    <section class="section-std case_wf_task casewf_top112  ">
        <div class="container">
            <div class="case-info-wrapper">
                <div class="case-task-wrapper">
                    <div class="case-task-wrapper__task">
                        <h3>Задача:</h3>
                        <p><?php the_field('task') ?></p>
                    </div>
                    <div class="case-task-wrapper__realiz">
                        <h3>Реализация:</h3>
    ...
    <section class="section-std section-wf-std casewf_top112 grey-background dev-site" >
        <div class="container">
        ...
        <!-- <div class='case-main-screen__img image-postion'> -->
        <img class='dev-site__img' src="<?php $image = get_field('razrabotka_logotipa_illyustracziya'); if( !empty($image) ): ?> <?php echo $image['url']; ?><?php endif; ?>" alt="">
            <!-- </div> -->
    </section>
    <section class="section-std section-wf-std casewf_top112 background-image-positon">
  ...
  <section class="section-std section-wf-std casewf_top112 grey-background">
    <div class="container black-color">
    ...
    <section class="section-std section-wf-std casewf_top112 casewf_bottom400">
        ...
        <div class='case-main-screen__img page-main_img'>
                <?php 
    ...
    <section class="section-std section-wf-std casewf_top112 background-image-all">
        <div class="container text-width-25">
    ...
    <section class="section-std section-wf-std casewf_top250 dev-site" >
        <div class="container">
        ...
        <!-- <div class='case-main-screen__img image-postion'> -->
        <img class='dev-site__img' src="<?php $image = get_field('adaptivnyj_dizajn_ilust'); if( !empty($image) ): ?> <?php echo $image['url']; ?><?php endif; ?>" alt="">
            <!-- </div> -->
    </section>
  ...
  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112">
    ...
    <section class="section-std section-wf-std casewf_top112 grey-background dev-site copiryt" >
        <div class="container">
        ...
        <!-- <div class='case-main-screen__img image-postion'> -->
        <img class='dev-site__img' src="<?php $image = get_field('kopirajting_ilyustracziya'); if( !empty($image) ): ?> <?php echo $image['url']; ?><?php endif; ?>" alt="">
            <!-- </div> -->
    </section>
