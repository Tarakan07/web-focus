...
<main class="casewf casewf_12">
  <section class="section-std case_wf_hero sub-hero case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_1.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std case_wf_task casewf_top112 casewg_pb0_650 casewf_bottom0 case_wf_color">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Торговая компания «Фаворит» предоставляет широкий спектр продукции для строительной, дорожной и прочей спецтехники: оригинальные комплектующие и высококачественные аналоги запчастей. Перед нами стояла задача разработать удобный сайт-каталог продукции и обеспечить его продвижение.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы проанализировали ассортимент компании и создали грамотную структуру сайта, что в последующем также стало основой для seo-продвижения. Брифинг и глубинное интервью дали нам понимание какой функционал особенно важно реализовать на будущем сайте.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-std section-wf-std casewf_top112 case_wf_color casewf_bottom0">
    <div class="container">
      <h2 class="section-title">Разработка сайта</h2>
      <p class='section-p ms-740'>Благодаря качественному анализу конкурентов и ниши, мы учли основные информационные блоки и хорошо проработали структуру проекта, согласно семантики. Особенно внимание уделили проработке каталога и созданию удобного фильтра по поиску комплектующих и запчастей.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_2.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color casewf_bottom0 casewf_mw1696">
    <div class="container">
      <h2 class="section-title">Адаптивная версия сайта</h2>
      <p class='section-p ms-740'>Большая часть трафика сайта приходится на мобильные устройства, поэтому мы разработали его адаптивную версию. Таким образом, пользователям удобно взаимодействовать с ресурсом с любого устройства и разрешения экрана.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_3.png" alt="" class='hide_image_1090'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_3_1090.png" alt="" class='show_image_1090 hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_3_650.png" alt="" class='show_image_650'>
    </div>

  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50 case_wf_color">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      <h2 class="section-title">SEO-продвижение</h2>
      <h4 class='section-p'>Сфера - Продажа автозапчастей</h4>
      <h4 class='section-p'>Возраст сайта - новый сайт</h4>
      ...
      <div class="custom-style__seo-text">
        <p>
        Из-за того, что сайт новый, предстояла большая работа по его оптимизации и привлечению органического трафика.
        </p>
      </div>
      ...
      <div class="custom-style__seo-text">
        В начале работ трафик составлял 0 посетителей в неделю, а за 12 месяцев работы вырос до 4580 визитов в неделю.
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_4.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
      Процент ключей в ТОП-10 по итогам работы составил 69%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_5.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color casewf_top0">
    <div class="container">
      <h2 class="section-title">Копирайтинг</h2>
      <p class='section-p ms-740'>Для каждой страницы на сайте написаны уникальные тексты, соответствующие всем параметрам SEO, что способствуют продвижению страниц в поисковой выдаче. Также, в текстах карточек товаров мы учли все важные для пользователя характеристики продукции.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case12_6.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std section-std-bottom-0 case_wf_color">
    <div class="container custom-style__padding-bottom-50">
      ...
      <p class='section-p ms-740'>Разработанный сайт удобен для пользователя, на нем легко находить нужные комплектующие, запчасти и информацию. Успешная работа по SEO-оптимизации позволила привлечь постоянный органический трафик на сайт.</p>
