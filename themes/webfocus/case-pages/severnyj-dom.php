...
<main class="casewf casewf_14">
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Привлечение новых клиентов для строительной компании “Северный дом” путем создания стильного и удобного сайта.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы разработали стильный, минималистичный сайт, отлично отражающий дух компании “Северный дом”. На сайте в удобном каталоге представлены все услуги, предоставляемые компанией. Дизайн с множеством иллюстраций помогает клиенту сориентироваться в услугах и выбрать то, что ему необходимо.</p>
          </div>
        </div>
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case14_2.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112 ">
    <div class="container">
      ...
      <p class='section-p ms-740'>Для каждой страницы на сайте написаны уникальные тексты, соответствующие всем параметрам SEO, они хорошо продвигают сайт в поисковых системах. А дизайн-шаблон подстроен под большие объемы и хорошо структурирует информацию.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case14_3.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std our-team case_wf_color section-wf-width casewf_bottom112 casewf_top112">
  ...
  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      <h2 class="section-title">Сфера – корпоративный сайт
      </h2>
      <h4 class='section-p'>Сфера - бизнес-портал</h4>
      <h4 class='section-p'>Возраст – 5 лет 7 мес</h4>
      <h4 class='section-p'>Трафик на старте – меньше 100 посетителей в неделю</h4>
      <h4 class='section-p'>Проблематика:</h4>
      <div class="custom-style__seo-text">
        <p>
          Сайт с возрастом и небольшим ссылочным профилем. Перестал расти органический трафик. Необходимо расширить перечень предоставляемых услуг.
        </p>
      </div>
      <h4 class='section-p '>Изначально была небольшая структура сайта и небольшой охват ключевых слов. При проведении аудита сайта было выявлены технические ошибки, которые влияли на продвижение сайта:</h4>
      <div class='custom-style__seo-text'>
      ...
      <div class="custom-style__seo-text">
        В начале работ трафик составлял меньше 100 посетителей в неделю, а за 6 месяцев работы вырос до 3750 визитов в неделю.
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case14_4.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 35%: (нужно изменить)
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case14_5.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case14_6.png" alt="" class=''>
      </div>
    </div>
  </section>
