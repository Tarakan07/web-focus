...
<main class="casewf casewf_13">
  <section class="section-std case_wf_hero sub-hero case_wf_color2 casewf_grad">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_1.png" alt="" class=''>
    </div>
  </section>
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>ОК4 academy — онлайн-академия красоты, где обучаются мастера маникюра, бровей и ресниц. Перед нами стояла задача по разработке сайта для академии, который будет представлять курсы академии и привлекать новых учеников.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы проанализировали сайты конкурентов и провели опрос учеников академии, что помогло нам выявить какую информацию чаще всего хотят знать потенциальные ученики во время выбора курса и что крайне необходимо воплотить в сайте заказчика.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-std section-wf-std casewf_top112 ">
    <div class="container">
      ...
      <p class='section-p ms-740'>Основным шрифтом стал шрифт без засечек — Gilroy. В цветовой палитре 3 основных цвета, которые легко воспринимаются и сочетаются между собой.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_2.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_2_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 casewf_bottom0 case_wf_color casewf_mt174">
    <div class="container">
      <h2 class="section-title">Вдохновение</h2>
      <p class='section-p ms-740'>Перед созданием дизйна мы увидели фотографии клиента и захотели передать их воздушность в сайте.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_3.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_3_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112 case_wf_color casewf_bottom0">
    <div class="container">
      ...
      <p class='section-p ms-740'>На главной странице мы добавили информацию о преимуществах академии, перечень курсов и их программы, часто задаваемые вопросы и работы учеников.</p>

      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_4.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color casewf_bottom0 casewf_mw832">
    <div class="container">
      <h2 class="section-title">Дизайн адаптивной версии и разработка сайта</h2>
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_5.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case13_5_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std section-std-bottom-0 case_wf_color">
    <div class="container custom-style__padding-bottom-50">
      ...
      <p class='section-p ms-740'>Разработанный сайт академии с современным дизайном и адаптивен для всех разрешений экранов. Потенциальным ученикам легко найти нужную информацию и записаться на курс.</p>
      <div class="casewf_link">
        <a href="#">Перейти на сайт</a>
      </div>
