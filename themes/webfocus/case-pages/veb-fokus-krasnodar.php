...
/*
Template Name: Веб Фокус Краснодар
...
<main class="casewf casewf_18">
  <section class="section-std case_wf_hero sub-hero casewf_grad ">
  ...
  <section class="section-std section-wf-std casewf_top112 case_wf_color section-wf-width">
      <div class=''>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case18_4.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case18_4_650.png" alt="" class='show_image_650'>
      </div>
  </section>

  <section class="section-std section-wf-std case_wf_color casewf_bottom0">
    <div class="container">
      <h2 class="section-title">Разработка сайта</h2>
      <p class='section-p ms-740'>Главная страница разработана в соответствии со последними стандартами. Она быстро загружается, качественно отражает необходимый материал и выполняет эстетическую функцию, изобилуя анимациями.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case18_2.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std case_wf_color casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>Главная страница разработана в соответствии со последними стандартами. Она быстро загружается, качественно отражает необходимый материал и выполняет эстетическую функцию, изобилуя анимациями.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case18_3.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case18_3_930.png" alt="" class='hide_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case18_3_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
