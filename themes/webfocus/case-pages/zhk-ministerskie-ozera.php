...
/*
Template Name: ЖК Министерские озера
...
<main class="casewf casewf_11">
  <section class="section-std case_wf_hero sub-hero case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case11_1.png" alt="" class=''>
    </div>
  </section>
    ...
    <div class="container">
      <div class="case-info-wrapper">
        ...
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case11_2.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case11_3.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case11_4.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case11_5.png" alt="" class=''>
      </div>
    </div>
  </section>
