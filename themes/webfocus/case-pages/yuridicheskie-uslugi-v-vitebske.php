...
/*
Template Name: Юридические услуги  в Витебске
...
<main class="casewf casewf_4">
    ...
    <div class="case_wf_hero_container case_wf_hero_inner">
      <div class="case_wf_hero_wrapper">
        ...
        <div class="casewf_link">
          <a href="https://yuristvitebsk.by/">Перейти на сайт</a>
        </div>
      </div>
    </div>
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_1.png" alt="" class=''>
    </div>
  </section>
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Юридическая компания “МК-Правовые технологии” - наш постоянный клиент. В этот раз они обратились к нам в связи с расширением компании и созданием филиала по городу Витебску и Витебской области. Им нужен был удобный сайт для регионального филиала.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы разработали для компании удобный сайт. На главной странице находится исчерпывающая информация о компании и список предоставляемых услуг. Архитектура сайта интуитивно понятна: в нем удобно ориентироваться. А благодаря дружелюбному дизайну комфортно пользоваться сайтом смогут люди разных возрастов. </p>
          </div>
        </div>
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_2.png" alt="" class=''>
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_2_650.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>Главная страница сайта полностью реализует все необходимые задачи: она представляет компанию, рассказывает об услугах и знакомит с экспертами, а также дает возможность связаться с менеджерами.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_3.gif" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf576">
    <div class="container">
      <h2 class="section-title">Визуальный язык сайта</h2>
      <p class='section-p ms-740'>У компании уже был фирменный цвет - золотой, и он должен был присутствовать в дизайне. Мы подобрали цвета, сочетающиеся с фирменным цветом. Также подобрали удобочитаемый шрифт, который будет читаем для пользователей разных возрастов.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_4.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_4_930.png" alt="" class='show_image_930'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std">
    <div class="container">
      <h2 class="section-title">UI элементы</h2>
      <p class='section-p ms-740'>Элементы взаимодействия на сайте лаконичны и продуманы. Они помогают пользователю ориентироваться в выбранных опциях и имеют эстетическую ценность. </p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_5.png" alt="" class='hide_image_1090'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_5_1090.png" alt="" class='show_image_1090 hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_5_930.png" alt="" class='show_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_5_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color section-wf-width">
    <div class="container">
      <h2 class="section-title">Дизайн второстепенных страниц</h2>
      <p class='section-p ms-740'>Для второстепенных страниц сайта был разработан дизайн. Также для каждой из них были написаны уникальные тексты, которые помогают в продвижении в поисковых системах.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_6.png" alt="" class=''>
    </div>

  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color2">
    <div class="container">
      <h2 class="section-title">Формы и элементы</h2>
      <p class='section-p ms-740'>На сайте присутствуют интерактивные элементы: например, слайдеры с отзывами или услугами. Также на нем есть много CTA-элементов (call to action), которые захватывают потенциальных клиентов, призывая связаться с менеджерами и оставить заявку.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_7.png" alt="" class='hide_image_1090'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_7_1090.png" alt="" class='show_image_1090'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color casewf_bottom0 section-wf-width casewf_bottom112">
    <div class="container">
      <h2 class="section-title">Адаптивный дизайн</h2>
      <p class='section-p ms-740'>Адаптивный дизайн на сайте также хорошо реализован: сайт подстраивается под разные устройства, не ломается при перестроении и хорошо выглядит на экранах разных разрешений.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_8.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112 case_wf_color2">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      <h2 class="section-title">SEO-продвижение</h2>
      <h4 class='section-p'>Сфера – юридические услуги</h4>
      <h4 class='section-p'>Возраст – 1 год 1 мес</h4>
      <h4 class='section-p'>Трафик на старте – 0 посетителей в неделю</h4>
      <h4 class='section-p'>Решение:</h4>
      <div class='custom-style__seo-text'>
        <p>Работы по проекту начали с комплексного аудита сайта и разработки стратегии продвижения: </p>
        <ul>
          <li>Исправить все технические ошибки</li>
          <li>Расширить семантическое ядро</li>
          <li>Крауд-маркетинг</li>
          <li>Удаление «битых» ссылок</li>
          <li>Проведение Usability-анализа</li>
          <li>Составление контент-плана</li>
          <li>Написание SEO-текстов</li>
          <li>Доработки текстов в соответствии с требованиями клиента</li>
          <li>Лечение сайта от вирусов. Установка безопасности сайта</li>
        </ul>
      </div>
      <h4 class='section-p '>Итоги:</h4>
      <div class='custom-style__seo-text'>
        <p>В начале работ трафик составлял 0 посетителей в неделю, а за 10 месяцев работы вырос до 45 визитов в неделю. </p>
        <ul>
          <li>Исправить все технические ошибки</li>
          <li>Расширить семантическое ядро</li>
          <li>Расширить структуру сайта</li>
          <li>Составление контент-плана</li>
          <li>Удаление битых ссылок</li>
        </ul>
      </div>
      <h4 class='section-p '>Итоги:</h4>
      <div class="custom-style__seo-text">
        В начале работ трафик составлял 0 посетителей в неделю, а за 12 месяцев работы вырос до 2750 визитов в неделю.
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_9.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Прогноз трафика вырос:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_10.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Динамика роста средней позиции за время работы:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case4_11.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std section-std-bottom-0 casewf_top112">
    <div class="container custom-style__padding-bottom-50">
      <h2 class="section-title">Результат</h2>
      <p class='section-p ms-740'>Сайт хорошо продвигается в поисковых системах благодаря грамотной SEO-оптимизации и привлекает новых клиентов. Он качественно разработан и реализован и приносит компании прибыль.</p>
      <div class="casewf_link">
        <a href="https://yuristvitebsk.by/">Перейти на сайт</a>
      </div>
      <a href="/case/" class='custom-style__other-case__wrapper custom-style__flex-row'>
        ...
        <div>
          <svg width="46" height="15" viewBox="0 0 46 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M45.547 8.20711C45.9375 7.81658 45.9375 7.18342 45.547 6.79289L39.183 0.428932C38.7925 0.0384078 38.1593 0.0384078 37.7688 0.428932C37.3783 0.819457 37.3783 1.45262 37.7688 1.84315L43.4256 7.5L37.7688 13.1569C37.3783 13.5474 37.3783 14.1805 37.7688 14.5711C38.1593 14.9616 38.7925 14.9616 39.183 14.5711L45.547 8.20711ZM0.839844 8.5L44.8398 8.5V6.5L0.839844 6.5L0.839844 8.5Z" fill="url(#paint0_linear_1201_4152)" />
            <defs>
              <linearGradient id="paint0_linear_1201_4152" x1="-6.31749" y1="8.59987" x2="-6.27563" y2="6.21901" gradientUnits="userSpaceOnUse">
                <stop stop-color="#AB85FF" />
                <stop offset="0.526042" stop-color="#EBA3E3" />
                <stop offset="1" stop-color="#FFDBE4" />
              </linearGradient>
