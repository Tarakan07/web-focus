...
/*
Template Name: Жилой комплекс «Метрополь»
...
<section class="section-std case_wf_hero sub-hero case_wf_color2 case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case26_1.png" alt="" class='hide_image_650'>
    </div>
  </section>
  ...
  <section class="section-std case_wf_task casewf_top112 casewf_bottom0 case_wf_color">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case26_2.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  case_wf_color">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case26_3.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  case_wf_color">
    <div class="container">
      <h2 class="section-title">Мобильная версия сйта</h2>
      <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>
      <div class='case-main-screen__img casewf26_mw1'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case26_4.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case26_4_650.png" alt="" class='show_image_650'>
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case26_5.png" alt="" class=''>
      </div>
    </div>
  </section>
