...
<main class="casewf casewf_21">
  <section class="section-std case_wf_hero sub-hero case_wf_color2 case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case21_1.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std case_wf_task casewf_top112 casewg_pb0_650 casewf_bottom0 case_wf_color casewg_pt0_650">
    <div class="container">
      <div class="case-info-wrapper">
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 case_wf_color">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case21_2.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 case_wf_color">
    <div class="container">
      ...
      <p class='section-p ms-740'>Для каждой страницы на сайте написаны уникальные тексты, соответствующие всем параметрам SEO, они хорошо продвигают сайт в поисковых системах. А дизайн-шаблон подстроен под большие объемы и хорошо структурирует информацию.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case21_3.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case21_3_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112 case_wf_color">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case21_4.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case21_5.png" alt="" class=''>
      </div>
    </div>
  </section>
