...
/*
Template Name: Web Focus Minsk1
...
<main class="casewf casewf_15">
  ...
  <div class="case_wf_color3">
    ...
    <section class="section-std section-wf-std casewf_top112 casewf_bottom0 section-wf-width casewf_pl160">
      <div class="container">
        ...
        <p class='section-p ms-740'><?php the_field('ui_elementypodzagolovok') ?></p>
      </div>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'><?php the_field('razrabotka_logotipa_podzagolovok') ?></p>
  ...
  <section class="section-std section-wf-std case_wf_color casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'><?php the_field('lenta-instagram') ?></p>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'><?php the_field('ppc-kontekstnaya-reklama') ?></p>
