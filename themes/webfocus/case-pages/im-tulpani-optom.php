...
/*
Template Name: ИМ Тюльпаны оптом
...
<main class="casewf casewf_29">
  <section class="section-std case_wf_hero sub-hero case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case29_1.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std case_wf_task casewf_top112 case_wf_color">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Компания “Бизнес Квартал” занимается продажей готового бизнеса. К нам обратились за редизайном сайта компании по Беларуси с целью повысить обороты бизнеса посредством привлечения новых клиентов.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы создали удобный сайт, соответствующий последним трендам в дизайне и правилам UI/UX-дизайна. Сайт очень информативен, на нем сконцентрировано и грамотно разбито на блоки большое количество информации: ее удобно найти, и в ней не запутаются пользователи. Сайт минималистичный и создает ощущение легкости.  </p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="section-std section-wf-std our-team custom-style__padding-bottom-50 case_wf_color">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case29_2.svg" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case29_3.svg" alt="" class=''>
      </div>
    </div>
  </section>
