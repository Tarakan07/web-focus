...
/*
Template Name: Жилой комплекс «Юг море»
...
<main class="casewf casewf_25">
  ...
  case_wf_color casewf25_mw1">
    ...
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case25_2.png" alt="" class='hide_image_930'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case25_2_930.png" alt="" class='show_image_930'>
    </div>

  </section>

  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 
  case_wf_color casewf25_mw2">
    <div class="container">
      <h2 class="section-title">Разработка сайта</h2>
      <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>
    </div>
    <div class='case-main-screen__img'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case25_3.png" alt="" class=''>
    </div>

  </section>

  <section class="section-std section-wf-std casewf_bottom0 casewf_top112 
  case_wf_color casewf25_mw3">
    <div class="container">
      <h2 class="section-title">Мобильная версия сайта</h2>
      <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case25_4.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case25_4_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
