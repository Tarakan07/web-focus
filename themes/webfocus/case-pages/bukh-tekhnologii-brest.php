<?php
/*
Template Name: Бухгалтерские технологии Брест
...
<section class="section-std case_wf_hero sub-hero case_wf_color2 casewf_grad">
    <div class="case_wf_hero_container case_wf_hero_inner">
      <div class="case_wf_hero_wrapper">
        <div class="sub-hero-wrapper case">
          <div class="breadcrumb black-separator">
            <?php
        ...
        <div class="case-info-wrapper">
          <div class='case-info black-color'>
  ...
  <section class="section-std case_wf_task casewf_top112 casewf_bottom0 color-cherry">
    <div class="container">
      <div class="case-info-wrapper">
  ...
  <section class="section-std section-wf-std casewf_top112 color-cherry">
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      <h2 class="section-title">Формы и карточки</h2>
      <p class='section-p ms-740'><?php the_field("formy_i_kartochki_podzagolovok"); ?></p>
  ...
  <section class="section-std section-wf-std casewf_top112 color-grey">
  ...
  <section class="section-std section-wf-std casewf_top112 color-cherry">
    <div class="container white-color">
      ...
      <p class='section-p ms-740'><?php the_field("vtorostepennye_straniczy"); ?></p>
      <div class='case-main-screen__img'>
      <div class="desktop-image-block">
        <?php 
  ...
  <section class="section-std section-wf-std color-cherry">
