...
<main class="casewf casewf_20">
    ...
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>Компания “Бизнес Квартал” занимается продажей готового бизнеса. Они обратились к нам с целью создания нового корпоративного сайта.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Мы разработали удобный минималистичный сайт в корпоративных цветах компании с множеством информативных блоков, которые рассказывают об услугах, предоставляемых компанией, о сути самой компании и уникальных возможностях, которые появляются у клиента при покупке бизнеса именно у “Бизнес Квартал”.</p>
          </div>
        </div>
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_2.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>Для сайта была подобрана шрифтовая пара: шрифт без засечек “Graphik LCG” и “PF Agora Sans Pro”. В цветоой палитре использовали фирменные цвета.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_3.gif" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>На логотипе изобаржено высотное здание, что ассоциируеся с бизнесом и обыгрывает название “Бизнес Квартал”. В логотипе используется яркий корпоративный цвет.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_4.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_bottom0 casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>На сайте использованы два корпоративных цвета - красный и зеленый. В качестве шрифта использован легкий Roboto без засечек. Сайт яркий, но при этом не напрягает глаз. С ним удобно взаимодействовать.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_5.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_5_930.png" alt="" class='show_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_5_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color3">
    <div class="container">
      <h2 class="section-title">UI-Kit</h2>
      <p class='section-p ms-740'>На сайте много CTA и форм взаимодействия. Все они собраны в UI-Kit’е. Разработчики качественно реализовали все нюансы и снабдили сайт плавной анимацией.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_6.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_6_930.png" alt="" class='show_image_930'>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>На сайте представлены удобные формы обратной связи с фильтрами, чтобы потенциальные клиенты могли оставить заявку для контакта с менеджером компании.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_7.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 case_wf_color">
    <div class="container">
      <h2 class="section-title">Визуальные элементы</h2>
      <p class='section-p ms-740'>На сайте присутствуют уникальные визуальные элементы - плитки, которые работают с анимацией. В них отражена общая суть страницы.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_8.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <p class='section-p ms-740'>Для второстепенных страниц на сайте был разработан дизайн-шаблон, а также написаны уникальные тексты, которые продвигают сайт в поисковых системах.</p>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case20_9.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std section-std-bottom-0">
