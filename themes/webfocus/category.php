...
?>
<main>
  <section class="sub-hero blog-first-screen separate-category">
    <div class="container">
      <div class="sub-hero-wrapper">
        ...
        <div class="sub-hero__info-cat">
            <div class="sub-hero__info-cat_count"><img src="<?php echo get_template_directory_uri().'/assets/img/newspaper 1.svg' ?>"/><p>Всего статей: <?php echo get_category(get_cat_ID($thisCat->name))->category_count; ?></p></div>
