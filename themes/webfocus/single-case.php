...
<main>
    <div class="sub-hero-wrp">
        <section class="sub-hero blog-first-screen case">
            <div class="container">
                ...
                <div class="case-info-wrapper">
                    <div class='case-info'>
                        ...
                        <div class='case-info__item-wrapper'>
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/caseIcon/viewcase1.svg" alt="img">
                ...
                <div class="case-info-wrapper">
                    ...
                    <div class="style-pink-sqr">
                        <p><strong>Клиент: </strong><?php the_field('klient'); ?></p>
                        <p><strong>Сфера: </strong><?php the_field('sfera'); ?></p>
                        <p><strong>Тип сайта: </strong><?php the_field('tip_sajta'); ?></p>
                        <p><strong>CMS: </strong><?php the_field('cms'); ?></p>
                        <p><strong>Ссылка на проект: </strong><a href='<?php the_field('ssylka_na_proekt'); ?>'><?php the_field('ssylka_na_proekt'); ?></a></p>
                    </div>
                </div>
        </section>
    </div>
    <section class="section-std">
        <div class="container">
            <h2 class="wow section-title">Главная страница</h2>
            <p class='wow section-p ms-740'><?php the_field('glavnaya_stranicz'); ?></p>
    ...
    <?php if (get_field('razrabotka_logotipa_podzagolovok')) { ?>
        <section class="section-std section-std-top-0 section-std-bottom-0">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">Разработка логотипа</h2>
                <p class='wow section-p ms-740'><?php the_field('razrabotka_logotipa_podzagolovok'); ?></p>
                <div class='case-main-screen__img'>
                    <?php
                    $image = get_field('razrabotka_logotipa_illyustracziya');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('vizualnyj_yazyk_sajta')) { ?>
        <section class="section-std section-std-top-0">
            <div class="container">
                <h2 class="wow section-title">Визуальный язык сайта</h2>
                <p class='wow section-p ms-740'><?php the_field('vizualnyj_yazyk_sajta'); ?></p>
                <div class='case-main-screen__img custom-style__ui-elements-pc'>
                    <?php
                    $image = get_field('vizualnyj_yazyk_sajta_pc');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
                <div class='case-main-screen__img custom-style__ui-elements-mobile'>
                    <?php
                    $image = get_field('vizualnyj_yazyk_sajta_mobile');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('ui_elementypodzagolovok')) { ?>
        <section class="section-std our-team custom-style__padding-bottom-50">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">UI элементы</h2>
                <p class='wow section-p ms-740'><?php the_field('ui_elementypodzagolovok'); ?></p>
                <div class='case-main-screen__img custom-style__ui-elements-pc'>
                    <?php
                    $image = get_field('ui_elementy_pc');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
                <div class='case-main-screen__img custom-style__ui-elements-mobile'>
                    <?php
                    $image = get_field('ui_elementy_mobile');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('formy_podzagolovok')) { ?>
        <section class="section-std section-std-bottom-0">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">Формы</h2>
                <p class='wow section-p ms-740'><?php the_field('formy_podzagolovok'); ?></p>
                <div class='case-main-screen__img'>
                    <?php
                    $image = get_field('formy_ilyustracziya');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('navigacziya_po_sajtu_podzagolovok')) { ?>
        <section class="section-std section-std-bottom-0">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">Навигация по сайту</h2>
                <p class='wow section-p ms-740'><?php the_field('navigacziya_po_sajtu_podzagolovok'); ?></p>
                <div class='case-main-screen__img'>
                    <?php
                    $image = get_field('navigacziya_po_sajtu_ilyustracziya');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('formy_i_kartochki_podzagolovok')) { ?>
        <section class="section-std section-std-bottom-0">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">Формы и карточки</h2>
                <p class='wow section-p ms-740'><?php the_field('formy_i_kartochki_podzagolovok'); ?></p>
                <div class='case-main-screen__img'>
                    <?php
                    $image = get_field('formy_i_kartochki_illyustracziya');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('illyustraczii_podzagolovok')) { ?>
        <section class="section-std">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">Иллюстрации</h2>
                <p class='wow section-p ms-740'><?php the_field('illyustraczii_podzagolovok'); ?></p>
                <div class='case-main-screen__img custom-style__ui-elements-pc'>
                    <?php
                    $image = get_field('illyustraczii_pc');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
                <div class='case-main-screen__img custom-style__ui-elements-mobile'>
                    <?php
                    $image = get_field('illyustraczii_mobile');
                    if (!empty($image)) : ?>
                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
                </div>
    ...
    <?php } ?>
    <?php if (get_field('mobilnaya_versiya_sajtapodzagolovok')) { ?>
        <section class="section-std our-team section-std-bottom-0">
            <div class="container custom-style__padding-bottom-50">
                <h2 class="wow section-title">Мобильная версия сайта</h2>
                <p class='wow section-p ms-740'><?php the_field('mobilnaya_versiya_sajtapodzagolovok'); ?></p>
            </div>
        </section>
    <?php } ?>
    <?php if (get_field('slajder-zaglushka') == 1) { ?>
        <section class="section-std our-team custom-style__slider-padding">
            <div class='case-slider-wrapper-mask'>
                <img src="https://webfocus.by/wp-content/uploads/2021/08/slider-mask.png" alt="alt">
            </div>
    ...
    <?php } ?>
    <?php if (get_field('adaptivnyj_dizajnpodzagolovok')) { ?>
        <?php if (get_field('formy_podzagolovok') || get_field('formy_i_kartochki_podzagolovok') && !get_field('slajder-zaglushka')) { ?>
            <section class="section-std section-std-bottom-0 section-std-top-0">
            <?php } else { ?>
                <section class="section-std section-std-bottom-0">
                <?php } ?>
                <div class="container custom-style__padding-bottom-50">
                    <h2 class="wow section-title">Адаптивный дизайн</h2>
                    <p class='wow section-p ms-740'><?php the_field('adaptivnyj_dizajnpodzagolovok'); ?></p>
                    <div class='case-main-screen__img'>
                        <?php
                        $image = get_field('adaptivnyj_dizajn_ilust');
                        if (!empty($image)) : ?>
                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                        <?php endif; ?>
                    </div>
            ...
            <?php } ?>
            <?php if (get_field('vtorostepennye_straniczy')) { ?>
                <?php if (get_field('seo-prodvizhenie') == 1) { ?>
                    <section class="section-std section-std-top-0 ">
                        <div class="container">
                        <?php } else { ?>
                            <section class="section-std section-std-top-0 section-std-bottom-0">
                                <div class="container custom-style__padding-bottom-50">
                                <?php } ?>
                                <h2 class="wow section-title">Второстепенные страницы</h2>
                                <p class='wow section-p ms-740'><?php the_field('vtorostepennye_straniczy'); ?></p>
                                <div class='case-main-screen__img'>
                                    <?php
                                    $image = get_field('vtorostepennye_straniczy_ilyustracziya');
                                    if (!empty($image)) : ?>
                                        <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                                    <?php endif; ?>
                                </div>
                        ...
                        <?php } ?>
                        <?php if (get_field('lenta-instagram')) { ?>
                            <section class="section-std section-std-bottom-0">
                                <div class="container custom-style__padding-bottom-50">
                                    <h2 class="wow section-title">Лента Instagram</h2>
                                    <p class='wow section-p ms-740'><?php the_field('lenta-instagram'); ?></p>
                                    <div class='case-main-screen__img custom-style__ui-elements-pc'>
                                        <?php
                                        $image = get_field('lenta-instagram-pc');
                                        if (!empty($image)) : ?>
                                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                                        <?php endif; ?>
                                    </div>
                                    <div class='case-main-screen__img custom-style__ui-elements-mobile'>
                                        <?php
                                        $image = get_field('lenta-instagram-mobile');
                                        if (!empty($image)) : ?>
                                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                                        <?php endif; ?>
                                    </div>
                        ...
                        <?php } ?>
                        <?php if (get_field('ppc-kontekstnaya-reklama')) { ?>
                            <section class="section-std section-std-bottom-0">
                                <div class="container custom-style__padding-bottom-50">
                                    <h2 class="wow section-title">PPC (контекстная реклама)</h2>
                                    <p class='wow section-p ms-740'><?php the_field('ppc-kontekstnaya-reklama'); ?></p>
                                    <div class='case-main-screen__img custom-style__ui-elements-pc'>
                                        <?php
                                        $image = get_field('ppc-kontekstnaya-reklama-pc');
                                        if (!empty($image)) : ?>
                                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                                        <?php endif; ?>
                                    </div>
                                    <div class='case-main-screen__img custom-style__ui-elements-mobile'>
                                        <?php
                                        $image = get_field('ppc-kontekstnaya-reklama-mobile');
                                        if (!empty($image)) : ?>
                                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                                        <?php endif; ?>
                                    </div>
                        ...
                        <?php } ?>
                        <?php if (get_field('kopirajting')) { ?>
                            <section class="section-std section-std-bottom-0">
                                <div class="container custom-style__padding-bottom-50">
                                    <h2 class="wow section-title">Копирайтинг</h2>
                                    <p class='wow section-p ms-740'><?php the_field('kopirajting'); ?></p>
                                    <div class='case-main-screen__img'>
                                        <?php
                        ...
                        <?php if (get_field('seo-prodvizhenie') == 1) { ?>
                            <section class="section-std our-team custom-style__padding-bottom-50">
                                <div class="container custom-style__padding-bottom-50 custom-style__seo">
                                    <h2 class="wow section-title">SEO-продвижение</h2>
                                    <h4 class='section-p'>Сфера - <?php the_field('sfera_seo'); ?></h4>
                                    <h4 class='section-p'>Возраст - <?php the_field('vozrast'); ?></h4>
                                    <h4 class='section-p'>Трафик на старте - <?php the_field('trafik_na_starte'); ?></h4>
                                    ...
                                    <div class='custom-style__seo-text'>
                                        <?php the_field('reshenie'); ?>
                                    </div>
                                    <h4 class='section-p '>Итоги:</h4>
                                    <div>
                                        <?php the_field('itogipodzagolovok'); ?>
                                    </div>
                                    <div class='case-main-screen__img'>
                                        <?php
                        ...
                        <?php } ?>
                        <?php if (get_field('korzina_i_lichnyj_kabinet_podzagolovok')) { ?>
                            <section class="section-std section-std-top-0 section-std-bottom-0">
                                <div class="container custom-style__padding-bottom-50">
                                    <h2 class="wow section-title">Корзина и личный кабинет</h2>
                                    <p class='wow section-p ms-740'><?php the_field('korzina_i_lichnyj_kabinet_podzagolovok'); ?></p>
                                    <div class='case-main-screen__img'>
                                        <?php
                                        $image = get_field('korzina_i_lichnyj_kabinet_illyustracziya');
                                        if (!empty($image)) : ?>
                                            <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                                        <?php endif; ?>
                                    </div>
