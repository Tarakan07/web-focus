...
/*
Template Name: Бизнес-площадка  Муравейник
...
<main class="casewf casewf_2">
  <section class="section-std case_wf_hero sub-hero case_wf_color">
    ...
    <div class="case_wf_hero_image">
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_1.png" alt="" class=''>
    </div>
  </section>

  <section class="section-std case_wf_task case_wf_color">
    <div class="container">
      <div class="case-info-wrapper">
        <div class="case-task-wrapper">
          <div>
            <h3>Задача:</h3>
            <p>“Муравейник” - проект, который позволяет приобрести или продать готовый бизнес. Задача - разработать сайт-портал для привлечения новых клиентов, оптимизировать внешние и внутренние процессы при помощи SEO и копирайтинга.</p>
          </div>
          <div>
            <h3>Реализация:</h3>
            <p>Разработкой ресурса занимались опытные программисты, которые действовали в тесной связке с дизайнерами. Нами был создан продуманный сайт-портал, в котором удобно ориентироваться любому клиенту. А благодаря нашим опытным SEO-специалистам сайт поднялся в рейтинге поисковых систем, что привлекло множество новых клиентов.</p>
          </div>
        </div>
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_2.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std case_wf_color">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_3.gif" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std our-team custom-style__padding-bottom-50 case_wf_color">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_4.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_5.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color case_wf_rel section-wf-width">
    <div class="container">
      <h2 class="section-title">Разработка сайта</h2>
      <p class='section-p ms-740'>Главная страница сайта включает в себя блоки, необходимые для понимания клиентом работы компании и предоставляемых ей услуг. Сайт легкий и минималистичный, в нем очень удобно ориентироваться.</p>
    </div>
    <div class='case-main-screen__img '>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_6.png" alt="" class='hide_image_930'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_6_930.png" alt="" class='show_image_930 hide_image_650'>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case2_6_650.png" alt="" class='show_image_650'>
    </div>
  </section>
