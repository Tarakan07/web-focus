...
<main class="casewf casewf_17">
    ...
    <div class="container">
      <div class="case-info-wrapper">
        ...
        <div class="case-task-wrapper-image">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case17_1.png" alt="" class=''>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case17_2.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case17_2_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std case_wf_color casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case17_3.png" alt="" class=''>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std casewf_top112 casewf_l141">
    <div class="container">
      <h2 class="section-title">Мобильная версия сайта</h2>
      <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>

      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case17_4.png" alt="" class=''>
      </div>
    </div>
  </section>
