...
<main class="casewf casewf_15">
  <section class="section-std case_wf_hero sub-hero case_wf_color2">
    ...
    <div class="case_wf_hero_item">
    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_it1.png" alt="" class=''>
    </div>
  </section>

  <div class="case_wf_color3">
    <section class="section-std case_wf_task casewf_top112 casewg_pb0_650 casewf_bottom0">
      <div class="container">
        <div class="case-info-wrapper">
          <div class="case-task-wrapper-image">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_2.png" alt="" class=''>
          </div>
          <div class="case-task-wrapper">
            <div>
              <h3>Задача:</h3>
              <p>Перед нами стала задача создать визуальный стиль для инстаграма магазина товаров для домашних животных vvpzoovet.by Перед нами стала задача создать визуальный стиль для инстаграма магазина товаров для домашних животных vvpzoovet.by</p>
            </div>
            <div>
              <h3>Реализация:</h3>
              <p>В результате мы создали дизайн с приятной цветовой палитрой, фотографиями животных и иллюстративными элементами, дополнили все шрифтом “Montserrat”.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="section-std section-wf-std casewf_top112 casewf_bottom0 section-wf-width casewf_pl160">
      <div class="container">
        <h2 class="section-title">Графические элементы сайта</h2>
        <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_3.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_3_930.png" alt="" class='show_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_3_650.png" alt="" class='show_image_650'>
      </div>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_4.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_5.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_5_930.png" alt="" class='show_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_5_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_6.png" alt="" class='hide_image_930'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_6_930.png" alt="" class='show_image_930 hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_6_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>

  <section class="section-std section-wf-std case_wf_color casewf_top112">
    <div class="container">
      <h2 class="section-title">Инстаграм</h2>
      <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>

      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_7.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_7_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      <h2 class="section-title">PPC</h2>
      <p class='section-p ms-740'>Разработчики уделили большое внимание адаптивной верстке. Сайт подстраивается под все устройства и хорошо выглядит на разных разрешениях экранов.</p>

      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_8.png" alt="" class='hide_image_650'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_8_650.png" alt="" class='show_image_650'>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std casewf_top112">
    <div class="container">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_9.png" alt="" class=''>
      </div>
    </div>
  </section>
  ...
  <section class="section-std section-wf-std custom-style__padding-bottom-50 casewf_top112">
    <div class="container custom-style__padding-bottom-50 custom-style__seo">
      ...
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_10.png" alt="" class=''>
      </div>
      <div class='section-p case-main-screen__img'>
        Процент ключей в ТОП-10 по итогам работы составил 59%:
      </div>
      <div class='case-main-screen__img'>
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/case/case15_11.png" alt="" class=''>
      </div>
    </div>
  </section>
